...
public class Chart {
    ...
    {
        return "ClassPojo [open = "+open+", vwap = "+vwap+", changePercent = "+changePercent+", change = "+change+", unadjustedVolume = "+unadjustedVolume+", volume = "+volume+", label = "+label+", high = "+high+", changeOverTime = "+changeOverTime+", low = "+low+", date = "+date+", close = "+close+"]";
    }
